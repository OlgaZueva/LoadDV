...
public class GetChargesSat {
    ...
    public GetChargesSat (Double price, Double unitCount, String allPaymentTerms, String units, int positionNr, String chargeGroup, Double roe, Double amount) {
        this.price = price;
    ...
    public boolean equals(Object o) {
        ...
        GetChargesSat that = (GetChargesSat) o;
