 ...
 * Предусловия:
 * 1. Запись в SA должна существовать. У нее: PartitionId = 0, tryCnt < MaxTryCount, srcSysId =1, statusHub = 0, cdcOperation = null,  остальные значения любые
    ...
    public void rowInDWHcdcOpIsNull() throws SQLException, IOException {
        ...
        if (hubStatus == null) {
            ...
            if (contRowInDWH == 1) {
                ...
                System.err.println("In DWH more then one record for these keys It'fail!");
            }
        }
    }
