...
public class zSQLforTestData {
    ...
    private String[] getValues(String tableName) {
        ...
        keys[4] = String.valueOf(0); //SrcSystemId
    ...
    public void getAllSQLs() {
        ...
        System.out.println("---------------------------");
        System.out.println("Insert into " + keys[0] + " (SELSKAB, SAGSNR, AFDELING, SrcSystemId, TryCnt,  PartitionId) Values ("
                + keys[1] + ", " + keys[2] + ", '" + keys[3] + "', " + keys[4] + ", " + keys[5] + ", " + keys[6] + ")");
        System.out.println("------");
        System.out.println("UPDATE " + keys[0] + " SET SrcSystemId = " + keys[4] + ", " + "TryCnt = " + keys[5] + ", "
                + "PartitionId = " + keys[6] + " WHERE SELSKAB = " + keys[1] + " and SAGSNR = " + keys[2]
                + " and AFDELING = '" + keys[3] + "' ");
        System.out.println("------");
    ...
    public String getInsertIntoSA(String tableName) {
        ...
        String insert = "Insert into " + keys[0] + " (SELSKAB, SAGSNR, AFDELING, SrcSystemId, TryCnt,  PartitionId) Values ("
                + keys[1] + ", " + keys[2] + ", '" + keys[3] + "', " + keys[4] + ", " + keys[5] + ", " + keys[6] + ")";
