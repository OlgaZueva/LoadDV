package TietoRus.Entity.FileLinerTests.Links;
...
public class TryCntMoreMax {
    ...
    private TietoRus.Entity.CompanyTests.zSQLforTestData companySQL = new TietoRus.Entity.CompanyTests.zSQLforTestData();
